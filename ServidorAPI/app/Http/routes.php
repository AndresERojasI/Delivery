...
Route::group(['domain' => DOMINIO], function () {
    ...
    Route::get('/posicion', function () {
        return \View::make('delivery.posicion');
    });
});
...
Route::group(['domain' => 'api.'.DOMINIO], function () {
    ...
    Route::group(['prefix' => '/'.VERSION_API], function () {
        ...
        Route::group(['prefix' => 'auth'], function () {
            ...
            Route::post('/logout', ['uses' => 'AutenticacionController@logout']); //Crear Usuario
        });

        //rutas de usuarios
        Route::group(['prefix' => 'usuarios', 'before' => 'oauth-user'], function () {
            ...
            Route::group(['prefix' => 'motociclistas'], function () {
                ...
                Route::post('/{id}/disponibilidad', ['uses' => 'UsuarioController@cambiarEstado']);//Cambiar el estado de disponibilidad
                Route::post('/{id}/geoposicion', ['uses' => 'UsuarioController@cambiarGeoposicion']);//Cambiar el estado de disponibilidad
            });
            ...
            Route::group(['prefix' => 'comercios'], function () {
                ...
                //Rutas de Productos
                Route::group(['prefix' => '{id_comercio}/productos'], function () {
