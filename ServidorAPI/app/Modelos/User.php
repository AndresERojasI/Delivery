...
class User extends \Moloquent implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    {
        return $this->hasMany('Shipper\Modelos\Badges');
    }

    public function vehiculo()
    {
        return $this->hasOne('Shipper\Modelos\Vehiculo');
    }

    public function configuracion()
    {
        return $this->hasOne('Shipper\Modelos\Configuracion');
    }

    public function geoposicion()
    {
        return $this->hasOne('Shipper\Modelos\Geoposicion');
    }

    public function cuenta()
    {
        return $this->hasOne('Shipper\Modelos\Cuenta');
    }
